          ...
          if ($ukuran_file <= 50000000) {
            ...
            if ($format == "pdf") {
                ...
                if (move_uploaded_file($file_asal, $file_tujuan)) {
                     $query = "INSERT INTO tb_surat_masuk(tgl_surat,id_user,no_surat,tipe_surat,id_jenis,indeks,no_agenda,kode_surat, sifat_surat, asal_surat,perihal,ket_surat,tgl_terima,penerima, ket_disposisi, scan_surat) VALUES('".$tgl_surat."','".$id_user."','".$no_surat."','".$tipe_surat."','".$id_jenis."','".$indeks."','".$no_agenda."','".$kode_surat."','".$sifat_surat."','".$asal_surat."','".$perihal."','".$ket_surat."','".$tgl_terima."','".$penerima."','".$ket_disposisi."','".$nama_file_baru."')";
