...
if (isset($_POST['ubah_foto'])) {
    ...
    if ($format == "pdf") {
        ...
        $file_tujuan = "../Upload/Surat_Masuk/".$nama_file_baru;

        if (move_uploaded_file($file_asal, $file_tujuan)) {
             $q_id = "SELECT * FROM tb_surat_masuk WHERE id_surat_masuk='".$id_surat_masuk."'";
           ...
           if (is_file("../Upload/Surat_Masuk/".$data_id['scan_surat'])) {
               unlink("../Upload/Surat_Masuk/".$data_id['scan_surat']); // Hapus file foto sebelumnya yang ada di folder images
               $query = "UPDATE tb_surat_masuk SET tgl_surat='".$tgl_surat."', no_surat='".$no_surat."', id_user='".$id_user."', tipe_surat='".$tipe_surat."', id_jenis='".$id_jenis."',indeks='".$indeks."',no_agenda='".$no_agenda."',kode_surat='".$kode_surat."',sifat_surat='".$sifat_surat."',asal_surat='".$asal_surat."',perihal='".$perihal."', ket_surat='".$ket_surat."', tgl_terima='".$tgl_terima."', penerima='".$penerima."', ket_disposisi='".$ket_disposisi."', scan_surat='".$nama_file_baru."' WHERE id_surat_masuk='".$id_surat_masuk."'";
    ...
    $query = "UPDATE tb_surat_masuk SET tgl_surat='".$tgl_surat."', no_surat='".$no_surat."', id_user='".$id_user."', tipe_surat='".$tipe_surat."', id_jenis='".$id_jenis."',indeks='".$indeks."',no_agenda='".$no_agenda."',kode_surat='".$kode_surat."',sifat_surat='".$sifat_surat."',asal_surat='".$asal_surat."',perihal='".$perihal."', ket_surat='".$ket_surat."', tgl_terima='".$tgl_terima."', penerima='".$penerima."',ket_disposisi='".$ket_disposisi."' WHERE id_surat_masuk='".$id_surat_masuk."'";
    $sql = mysqli_query($koneksi, $query); 
