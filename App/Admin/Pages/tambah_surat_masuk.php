        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
              ...
              <form role="form" method="post" action="Proses/add_surat_masuk.php" enctype="multipart/form-data">
              ...
              <tr>
               ...
               <tr>
                ...
                <td style="padding-left: 20px; padding-top: 10px;">
                  ...
                  <input type="text" name="tgl_terima" class="form-control pull-right" id="tgl_terima" required="required">
                </div>
                </td>
              </tr>
               ...
               <tr>
                ...
                <td style="padding-left: 20px; padding-top: 10px;">
                 <textarea class="form-control" rows="5" name="ket_disposisi" required="required"></textarea>
                </td>
              </tr>
