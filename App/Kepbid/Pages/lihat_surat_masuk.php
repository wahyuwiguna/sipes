      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            <i class="fa fa-paper-plane"></i>  Detail Surat Masuk
        ...
        <div class="col-xs-12">
         ...
         <?php 
            if ($data['status_disposisi']=='0') {
              echo "<a href='Proses/update_status.php?id_surat_masuk=$id_surat_masuk' class='btn btn-danger'><i class='fa fa-check' aria-hidden='true'></i>&nbsp;Tandai Sudah Dibaca</a>";
            }else{
         ...
         <?php 
            echo "<a href='../Admin/Upload/Surat_Masuk/".$data['scan_surat']."' class='btn btn-success' target='_blank'><i class='fa fa-eye' aria-hidden='true'></i>&nbsp;Lihat File Scan Surat</a>";
          ?>
