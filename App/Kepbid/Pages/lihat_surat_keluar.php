    ...
    <section class="content container-fluid">
      ...
      <div class="row no-print">
        ...
        <!--  <a href="index.php?ref=data_surat_keluar.php" class="btn btn-success"><i class="fa fa-reply" aria-hidden="true"></i>&nbsp;Kembali</a> -->
         ...
         <?php 
            echo "<a href='../Admin/Upload/Surat_Keluar/".$data['scan_surat']."' class='btn btn-warning' target='_blank'><i class='fa fa-eye' aria-hidden='true'></i>&nbsp;Lihat File Arsip Surat</a>";
          ?>
        </div>
      </div>
    </section>
