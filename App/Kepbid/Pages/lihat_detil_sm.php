...
AND MONTH(`tb_surat_masuk`.`tgl_terima`) = $bulan ORDER BY `tb_jenis_surat`.`jenis_surat` ASC";
  ...
  while ($data_sm = mysqli_fetch_array($sql_sm)) {
    ...
    echo "<td>".$data_sm['no_surat']."</td>";
   ?>
   <td style="text-align: center;">
   <a href='index.php?ref=lihat_surat_masuk.php&id_surat_masuk=<?php echo $data_sm['id_surat_masuk'] ?>' class='btn btn-primary btn-xs'><i class='fa fa-eye' aria-hidden='true'></i>&nbsp;Lihat</a>
   </td>
   <?php
    echo "</tr>";
  }
